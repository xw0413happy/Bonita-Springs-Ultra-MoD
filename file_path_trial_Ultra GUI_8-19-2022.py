...
def run_py_btn (file_path):
    # df = pd.read_excel(r'S:\LeeTran\Planning\Intern\Wang Xi\LeeTran_Wang\Ultra\Ultra_data.xlsx')
    file_path = filedialog.askopenfilename(initialdir='/', title="Select Ultra xlsx File Path", 
    ...
    try: 
        ...
        plt.title('Final status of unique trips',fontsize = 20)
        ...
        if trip_ID_df.date >= last_30_days:
        ...
        plt.title('Customizing the date range for final status of unique daily trips',fontsize = 20)
        ...
        plt.title('Customizing unique trip status by time of the day - Weekdays', fontsize = 15)
        ...
        plt.title('Customizing unique trip status by time of the day - Weekends', fontsize = 15)
...
def clicker():
    ...
    # my_img7 = my_img7.resize((my_img7.width // 4, my_img7.height // 4))
    # my_img7 = resizeimage.resize_cover(my_img7, [1300, 700])
    ...
    # my_img8 = my_img8.resize((my_img8.width // 4, my_img8.height // 4))
    # my_img8 = resizeimage.resize_cover(my_img8, [1300, 700])
    ...
    # my_img9 = my_img9.resize((my_img9.width // 4, my_img9.height // 4))
    # my_img9 = resizeimage.resize_cover(my_img9, [1300, 700])
    my_img9 = my_img9.resize((1200, 600))
    my_img9 = ImageTk.PhotoImage(my_img9)

    my_img10 = Image.open(r'S:\LeeTran\Planning\Technology\Python Projects\Bonita Springs Ultra GUI App\Final status of unique monthly trips.jpg')
    # my_img10 = my_img10.resize((my_img10.width // 4, my_img10.height // 4))
    # my_img10 = resizeimage.resize_cover(my_img10, [1200, 600])
    my_img10 = my_img10.resize((1200, 600))
    my_img10 = ImageTk.PhotoImage(my_img10)

    my_img11 = Image.open(r'S:\LeeTran\Planning\Technology\Python Projects\Bonita Springs Ultra GUI App\1-seat trip vs 2-seats monthly trip.jpg')
    ...
    my_img12 = Image.open(r'S:\LeeTran\Planning\Technology\Python Projects\Bonita Springs Ultra GUI App\Matched unique monthly trips.jpg')
    ...
    my_img13 = Image.open(r'S:\LeeTran\Planning\Technology\Python Projects\Bonita Springs Ultra GUI App\Customizing the date range for final status of unique daily trips.jpg')
    ...
    my_img14 = Image.open(r'S:\LeeTran\Planning\Technology\Python Projects\Bonita Springs Ultra GUI App\Customizing unique trip status by time of the day - Weekdays.jpg')
    ...
    my_img15 = Image.open(r'S:\LeeTran\Planning\Technology\Python Projects\Bonita Springs Ultra GUI App\Customizing unique trip status by time of the day - Weekends.jpg')
